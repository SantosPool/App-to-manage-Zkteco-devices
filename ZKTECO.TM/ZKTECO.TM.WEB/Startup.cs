...
using ZKTECO.TM.Repositories.Impl;
using ZKTECO.TM.Services.Impl;
...
namespace ZKTECO.TM.WEB
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped(typeof(IAttLogDAO), typeof(AttLogDAOImpl));
            services.AddScoped(typeof(IAttLogService), typeof(AttLogServiceImpl));
        }
