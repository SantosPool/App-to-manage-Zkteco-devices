...
namespace ZKTECO.TM.Database.NHibernate
{
    public interface IDAOGeneric<T, PK> where T : IGenericEntity<PK>
    {
        ...
        /// </summary>
        /// <param name="page">pagina que traerá en la lista</param>
        /// <param name="pageSize">numero de registros que traerá en la lista</param>
        /// <returns>retorna una lista paginada</returns>
        Page<T> PageItems(int page, int pageSize, string search);
    }
}
